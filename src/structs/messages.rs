...
pub enum MessageType {
  ...
  /// Guild security actions were enabled
  GUILD_INCIDENT_ALERT_MODE_ENABLED = 36,
  /// Guild security actions were disabled
  GUILD_INCIDENT_ALERT_MODE_DISABLED = 37,
  /// Raid was reported
  GUILD_INCIDENT_REPORT_RAID = 38,
  /// Raid was reported as a false alarm
  GUILD_INCIDENT_REPORT_FALSE_ALARM = 39,
  /// Something was purchased
  PURCHASE_NOTIFICATION = 44,
  /// Poll ended and results have been announced
  POLL_RESULT = 46,
...
impl Message {
  ...
  pub async fn edit<T: Into<MessageResponse>>(&self, rest: &Rest, message: T) -> Result<Message, RestError> {
    ...
    let Some(channel_id) = &self.channel_id else {
      return Err(RestError::InvalidStruct("Message has no channel_id"));
    };
  ...
  pub async fn delete(&self, rest: &Rest) -> Result<(), RestError> {
    ...
    rest.delete(format!("channels/{}/messages/{}", channel_id, id)).await
  }
  ...
  pub async fn crosspost(&self, rest: &Rest) -> Result<Message, RestError> {
    ...
    rest.post(format!("channels/{}/messages/{}/crosspost", channel_id, id), Value::Null).await
  }
  ...
  pub async fn create_reaction(&self, rest: &Rest, emoji: &Emoji) -> Result<(), RestError> {
    ...
    rest.put(format!("channels/{}/messages/{}/reactions/{}/@me", channel_id, id, emoji.to_url_format()), Value::Null).await
  }
  ...
  pub async fn delete_user_reaction<T: ToString>(&self, rest: &Rest, emoji: &Emoji, user_id: T) -> Result<(), RestError> {
    ...
    rest.delete(format!("channels/{}/messages/{}/reactions/{}/{}", channel_id, id, emoji.to_url_format(), user_id.to_string())).await
  }
  ...
  pub async fn get_reactions(&self, rest: &Rest, emoji: &Emoji, options: ReactionFetchOptions) -> Result<Vec<User>, RestError> {
    ...
    rest.get_query(format!("channels/{}/messages/{}/reactions/{}", channel_id, id, emoji.to_url_format()), options).await
  }
  ...
  pub async fn delete_all_reactions(&self, rest: &Rest) -> Result<(), RestError> {
    ...
    rest.delete(format!("channels/{}/messages/{}/reactions", channel_id, id)).await
  }
  ...
  pub async fn delete_all_reactions_for_emoji(&self, rest: &Rest, emoji: &Emoji) -> Result<(), RestError> {
    ...
    rest.delete(format!("channels/{}/messages/{}/reactions/{}", channel_id, id, emoji.to_url_format())).await
  }
  ...
  pub async fn start_thread(&self, rest: &Rest, options: ThreadCreateOptions) -> Result<Channel, RestError> {
    ...
    rest.post(format!("channels/{}/messages/{}/threads", channel_id, id), options).await
  }
  ...
  pub async fn get_poll_voters(&self, rest: &Rest, answer_id: i64, options: ReactionFetchOptions) -> Result<PollVoters, RestError> {
    ...
    rest.get_query(format!("channels/{}/polls/{}/answers/{}", channel_id, id, answer_id), options).await
  }
  ...
  pub async fn end_poll(&self, rest: &Rest) -> Result<Message, RestError> {
    ...
    rest.post(format!("channels/{}/polls/{}/expire", channel_id, id), Value::Null).await
  }

  /// Get a message reference for a reply pointing to this message
  /// ```
  /// # #[macro_use] extern crate slashook;
  /// # use slashook::commands::{CommandInput, CommandResponder, MessageResponse};
  /// # use slashook::structs::{interactions::ApplicationCommandType, messages::Message};
  /// # #[command(name = "Example Message Context", command_type = ApplicationCommandType::MESSAGE)]
  /// # fn example(input: CommandInput, res: CommandResponder) {
  /// let msg = input.target_message.unwrap();
  /// Message::create(&input.rest, msg.channel_id.as_ref().unwrap(), MessageResponse::from("hi").set_message_reference(msg.as_reply())).await?;
  /// # }
  /// ```
  pub fn as_reply(&self) -> MessageReference {
    MessageReference {
  ...
  /// Get a message reference for a forward pointing to this message
  /// ```
  /// # #[macro_use] extern crate slashook;
  /// # use slashook::commands::{CommandInput, CommandResponder, MessageResponse};
  /// # use slashook::structs::{interactions::ApplicationCommandType, messages::Message};
  ...
  /// # fn example(input: CommandInput, res: CommandResponder) {
  /// let msg = input.target_message.unwrap();
  /// Message::create(&input.rest, "613430047285706767", MessageResponse::from(msg.as_forward())).await?;
  /// # }
  /// ```
  pub fn as_forward(&self) -> MessageReference {
    MessageReference {
...
impl MessageReference {
  ...
  pub fn new_forward<T: ToString, U: ToString>(message_id: T, channel_id: U) -> Self {
    Self {
      reference_type: MessageReferenceType::FORWARD,
      message_id: Some(message_id.to_string()),
  ...
  /// Set the message reference type
  pub fn set_type(mut self, reference_type: MessageReferenceType) -> Self {
    self.reference_type = reference_type;
    self
  }

  /// Set the message ID
  pub fn set_message_id<T: ToString>(mut self, message_id: T) -> Self {
